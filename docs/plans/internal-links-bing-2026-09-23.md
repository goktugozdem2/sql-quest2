...
| 5 | Bing URL Submission for the remaining question pages, 100 a day — log in `docs/reads/bing-url-submissions.txt`; the next batch is every sitemap question URL not in that file | 99 sent 09-23, 100 sent 09-24; 124 left |
