...
2. **Activation is the denominator: people reaching six solves, 164 in the
   ...
   flips 10-01, reads 10-15 on the interview-ready opener), the Coach
   trusting that placement instead of asking twice (built 09-12, flips 09-27,
   reads 10-11 — 4 of 102 goal starters ever took a curriculum step), and the goal-picker gap (68.6% vs 35.2%,
