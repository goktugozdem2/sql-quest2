...
- Denormalized: Fewer joins, some redundancy`,
      ...
      challenge: {
        ...
        description: "The Titanic data has denormalized passenger info. Count how many passengers paid the same fare (possible group bookings).",
        dataset: "titanic",
        solution: "SELECT fare, COUNT(*) AS passengers FROM passengers WHERE fare > 0 GROUP BY fare HAVING COUNT(*) > 1 ORDER BY passengers DESC LIMIT 10;",
        hints: [
          "GROUP BY fare",
          "Filter out zero fares",
          "HAVING COUNT(*) > 1 for shared fares"
        ],
        points: 25
      }
    },
