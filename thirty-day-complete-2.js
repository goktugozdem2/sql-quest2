  ...
  const additionalDays = [
    ...
    // ============================================================
    {
      ...
      questions: [
        ...
        { id: "d17q5", difficulty: "hard", points: 25, title: "No Cabin Passengers", description: "Find Titanic passengers with no cabin.", solution: "SELECT Name, Cabin FROM passengers WHERE Cabin IS NULL;", alternativeSolutions: [], expectedResult: { columns: ["Name", "Cabin"], rowCount: 687, preview: [["Braund, Mr. Owen Harris", null]], note: "687 without cabin numbers" }, explanation: "77% had no cabin recorded." }
      ]
    },
...

    {
      ...
      questions: [
        { id: "d27q1", difficulty: "easy", points: 5, title: "Replace NULL", description: "NULL cabins → 'Unknown'.", solution: "SELECT Name, COALESCE(Cabin, 'Unknown') AS cabin FROM passengers;", alternativeSolutions: [], expectedResult: { columns: ["Name", "cabin"], rowCount: 891, preview: [["Braund, Mr. Owen Harris", "Unknown"]], note: "NULL → 'Unknown'" }, explanation: "COALESCE provides default." },
    ...
    // ============================================================
    {
      ...
      tableSchema: [
        ...
        { column: "Cabin", type: "TEXT", description: "Cabin number (687 NULL)" },
